...
public:
	...
	static Mesh BuildMeshGreedy(const ChunkMeshDependencies& chunk_mesh_dependencies, std::stop_token stop_token);
	...
	static void BuildAxisMesh(MajorAxis major_axis, const ChunkMeshDependencies& chunk_mesh_dependencies, std::stop_token stop_token, Mesh& chunk_mesh);
