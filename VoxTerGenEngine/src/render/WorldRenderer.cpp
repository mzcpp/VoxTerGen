...
void WorldRenderer::Tick(std::queue<ChunkEvent>& chunk_event_queue, const std::optional<RaycastResult>& raycast_result, const Camera& camera)
{
...
void WorldRenderer::RenderWorld(const glm::mat4& view, const glm::mat4& projection, const ResourceManager& resource_manager)
{
	...
	// skybox_render_pass_.RenderSkybox(projection, resource_manager);
}